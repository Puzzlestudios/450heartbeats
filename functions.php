...
function child_scripts() {
    ...
    wp_enqueue_script( 'gsap-all', 'https://cdn.jsdelivr.net/npm/gsap@3.12.5/dist/gsap.min.js', array('jquery') );
    wp_enqueue_script( 'select2', 'https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.13/js/select2.full.min.js' , array('jquery') );

    wp_enqueue_script( 'gsap_utils', get_stylesheet_directory_uri() .'/assets/js/gsap_utils.js' , array('gsapall') );
}
